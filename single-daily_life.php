    ...
    <article <?php post_class('mycontainer'); ?>>
        <div class="alignwide">
            <div class="myposthead">
                <div class="post-categories"><?php echo get_the_term_list($post->ID, 'event'); ?></div>
            ...
            <aside class="myshare">
                <h2><span class="dashicons dashicons-share"></span>SNSでシェア</h2>
            ...
            <?php comment_form(array(
                'title_reply' => '<span>'.esc_html__('コメントを残す', 'poseidon').'</span>',
                'comment_notes_after' => '',)); 
            ?>
            ...
            <aside class="myrelated">
                ...
                <div class="mypostlist">
                    <?php $myposts = get_posts(array(
                        'posts_per_page' => '4', 'post__not_in' => array(get_the_ID()), 
                        'category__in' => wp_get_post_categories(get_the_ID()), 'orderby' => 'rand' 
                    )); ?>
